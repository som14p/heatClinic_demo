...
public class Login extends PageObject {
	...
	private final ReportLogService logService = new ReportLogServiceImpl(Login.class);
	...
	private void accountLogin(String email, String password, String name) {
		...
		logService.info("INFO: Entering data in email field " + email);
		...
		wait.waitFor(LocatorType.XPATH, loginButtonXpath);
	...
	private void addAndRemoveFromCart() {
		...
		browser.getPageScroll().down(2000);
